...
import (
	"log"
	"mozart/bindings/conductor/task"
	"os"
	"time"
)
...
func (c *ConductorWorker) Execute(t *task.Task, executeFunction func(t *task.Task) (*task.Result, error)) {
...
func (c *ConductorWorker) PollAndExecute(taskType string, domain string, executeFunction func(t *task.Task) (*task.Result, error)) {
	for {
...
func (c *ConductorWorker) Start(taskType string, domain string, executeFunction func(t *task.Task) (*task.Result, error), wait bool) {
